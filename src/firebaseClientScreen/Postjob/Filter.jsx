          ...
          <div style={styles.leftPanel}>
            {menuItems.map((m) => (
              <div
                ...
                style={{
                  ...styles.menuItem,
                  background: activeSection === m.key ? "#F4F0FF" : "transparent",
                  color: activeSection === m.key ? "#6C3EEB" : "#1A1433",
                  fontWeight: activeSection === m.key ? 600 : 500,
                }}
              >
                {m.label}
              </div>
...
const Chip = ({ label, selected, onClick }) => (
  <div
    ...
    style={{
      ...styles.chip,
      background: selected ? "#F4F0FF" : "white",
      color: selected ? "#6C3EEB" : "#1A1433",
      border: selected ? "1px solid #6C3EEB" : "1px solid #EBE5F2",
...
const styles = {
  ...
  applyBtn: {
    flex: 1,
    height: 48,
    background: "linear-gradient(90deg, #6C3EEB 0%, #8A5CFF 100%)",
    border: "none",
    borderRadius: 8,
    color: "#fff",
    fontWeight: 600,
