...
useEffect(() => {
  ...
  // ✅ If job data passed from previous screen
  if (passedJob) {
    setJob({
      id: passedJob.id,
      title: passedJob.title,
      description: passedJob.description,
      budgetFrom: passedJob.budget_from,
      budgetTo: passedJob.budget_to,
      timeline: passedJob.timeline,
      skills: passedJob.skills || [],
      tools: passedJob.tools || [],
      applicantsCount: passedJob.applicants_count || 0,
      createdAt: passedJob.created_at?.toDate?.() || new Date(),
      userName: passedJob.clientName || "no username",
      role: passedJob.category || "no category",
      servicePosted: passedJob.service_posted || 3,
      completedProjects: passedJob.completed_projects || 10,
    });
