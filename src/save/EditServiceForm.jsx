...
export default function EditServiceForm() {
  ...
  return (
    <div className="add-service-wrapper" style={{ marginLeft: isMobile ? "0px" : collapsed ? "-190px" : "-90px", transition: "margin-left 0.25s ease" }}>
      <div className="add-service-container" style={{ maxWidth: "1000px" }}>
        <div className="add-service-header">
          ...
          <p className="add-service-subtitle">Update your service details to stay competitive.</p>
        </div>
          ...
          <div className="add-service-form" style={{ maxWidth: "100%", flex: 1 }}>
            ...
            <div className="form-card">
              ...
              <div className="add-service-grid-2" style={{ gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr" }}>
                ...
                <div>
                  <label className="add-service-label">Timeline</label>
                  <input
                    type="text"
                    className="add-service-input"
                    name="timeline"
            ...
            <div className="form-card">
              <div>
                <label className="add-service-label">Sample Project URL <span className="add-service-label-sub">(Optional)</span></label>
                <input
                  type="text"
                  className="add-service-input"
                  name="sample_project_url"
            ...
            <button onClick={handleUpdate} className="add-service-publish-btn">
              Update Service
            </button>
          </div>
        </div>
