...
const STEPS: StepItem[] = [
  {
    ...
    description:
      "Analytics activate automatically for every project on Huzzler.",
  },
  {
    number: "02",
    title: "Track live metrics",
    description:
      "Watch spend, time-to-hire, and delivery timelines update in real time.",
  },
  {
    number: "03",
    title: "Compare performance",
    description:
      "Benchmark freelancers and categories against your own history.",
  },
  {
    number: "04",
    title: "Act on insights",
    description:
      "Get a suggested action whenever a metric drifts off track.",
  },
];
...
const BUILT_FROM_ROWS: BuiltFromRow[] = [
  {
    ...
    description:
      "Projects are tracked as accepted, in progress, or completed, updated automatically as work moves forward.",
  },
  {
    title: "Review layer",
    description:
      "Completed projects collect reviews from both sides, feeding directly into performance benchmarks.",
  },
  {
    title: "Spend tracking",
    description:
      "Budget ranges from each project card roll up into portfolio-level spend reporting.",
  },
  {
    title: "Timeline accuracy",
    description:
      "Actual delivery is measured against the original timeline set on the project card.",
  },
];
...
const OUTCOME_CARDS: OutcomeCard[] = [
  {
    ...
    description:
      "See budget against actuals across every active project.",
  },
  {
    title: "Faster hiring cycles",
    description:
      "Spot bottlenecks in your process before they cost you time.",
  },
  {
    title: "Quality benchmarks",
    description:
      "Compare freelancer performance against category averages.",
  },
  {
    title: "Exportable reports",
    description:
      "Share clean summaries with stakeholders in one click.",
  },
];
...
const FAQ_ITEMS: FaqItem[] = [
  {
    question: "Do I need to update statuses manually?",
    answer:
      "No. Huzzler AI automatically tracks milestone submissions, deliverable approvals, time logs, and budget burn in real-time as work happens across your projects.",
  },
  {
    question: "Where do the benchmarks come from?",
    answer:
      "Performance scores are computed objectively from on-time delivery benchmarks, milestone completion accuracy, and verified client satisfaction ratings.",
  },
  {
    question: "Can I export this for a client report?",
    answer:
      "Yes. You can export complete project analytics, budget breakdowns, and milestone audits into CSV or presentation-ready PDF reports with a single click.",
  },
];
    ...
    <div className="w-full bg-[#F8F9FC] text-gray-900 font-sans selection:bg-[#6D4AFF] selection:text-white">
      ...
      >
        <div className="w-full max-w-[1440px] mx-auto h-full flex flex-col justify-center px-6 sm:px-10 md:px-12 lg:px-0 lg:pt-[162px] lg:pb-[100px] lg:pl-[162px] lg:pr-[518px] py-16 sm:py-20">
          <div className="relative z-10">
            ...
            {/* Heading */}
            <h1
              className="text-4xl sm:text-5xl lg:text-[58px] font-semibold text-white leading-tight lg:leading-[62.64px] tracking-[-1.16px] mb-5 font-['Inter',sans-serif]"
              style={{
            ...
            {/* Subtitle */}
            <p className="text-base sm:text-lg text-gray-300 max-w-[560px] leading-relaxed mb-9">
              Dashboards turn every hire, message, and milestone into a clear
              <br />
              signal — so you know what's working before it becomes a problem.
            </p>
      ...
      <section className="py-20 px-6 md:px-12 lg:px-16">
        <div className="max-w-[1180px] mx-auto">
          ...
          >
            Project Analytics is built to get out of your way — here's the path from first
            click to result.
          </p>
      ...
      {/* 3. SECTION: WHAT PROJECT ANALYTICS IS ACTUALLY BUILT FROM */}
      <section className="pb-20 px-6 md:px-12 lg:px-16">
        <div className="max-w-[1180px] mx-auto">
          ...
          >
            What Project Analytics is actually
            <br />
            built from
          </h2>
          ...
          >
            <p
              className="text-[14px] sm:text-[15.5px] leading-relaxed sm:leading-[23.25px] font-normal font-['Inter',sans-serif] text-[#5B5770] max-w-[845px] align-middle"
              style={{
                fontFamily: "'Inter', sans-serif",
                fontWeight: 400,
                fontSize: "15.5px",
            ...
            >
              Every project moves through the same status pipeline, so your dashboard is always reading real state, not guesses.
            </p>
          </div>
      ...
      {/* 5. SECTION: FREQUENTLY ASKED ABOUT PROJECT ANALYTICS */}
      <section className="pb-20 px-6 md:px-12 lg:px-16">
        <div className="max-w-[1180px] mx-auto">
          <h2
          ...
          >
            Frequently asked about Project Analytics
          </h2>
      ...
      {/* 7. SECTION: READY TO PUT PROJECT ANALYTICS TO WORK? (Dark Card Banner) */}
