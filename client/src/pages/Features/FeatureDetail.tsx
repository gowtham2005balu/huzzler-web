...
import AiTalentMatchingPage from "./AiTalentMatchingPage";
...
export default function FeatureDetail() {
  ...
  if (slugParam === "project-analytics") {
    return <ProjectAnalyticsPage />;
  }

  if (slugParam === "ai-talent-matching") {
    return <AiTalentMatchingPage />;
  }

  if (slugParam === "ai-assistant") {
    return <AiAssistantPage />;
  }

  if (slugParam === "portfolio-management") {
